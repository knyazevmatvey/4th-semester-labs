...
# Дифракция на щели
b = 0.30                # ширина щели
wavelength = 0.10       # длина волны 
k = 2*3.14/wavelength   # волновое число
...
vtkfile_real = File('one_source/real.pvd')
vtkfile_real << ans_re

vtkfile_im = File('one_source/im.pvd')
vtkfile_im << ans_im